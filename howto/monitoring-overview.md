...
### Google Cloud Production Environment (gprd)

![Logical scheme](../img/gprd-monitoring-infrastructure.png)
[draw.io source](../graphs/gprd-monitoring-infrastructure.xml) for later modifications.
